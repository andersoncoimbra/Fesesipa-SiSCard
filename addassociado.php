...
");
		...
		<span>
			<input id='element_1_1' name='F_nome' class='element text'  maxlength='255' size='38'  required/>
...
<input id='saveForm' class='button_text' type='submit' name='submit' value='Cadastrar' />
    ...
    <form id='form_1044499' class='appnitro'  method='post' action=''>
        ...
        if(isset($cad)) {
            if ($cad == 1) {
                echo "<p style='color: #22a20b; margin: 10px; padding: 10px;'>Cadastro relizado com sucesso</p>";
                echo "<a href='view/addDependente.php?D_assoc=$vrg' style='display: block; background-color: #cccccc; width: auto; margin: 10px; padding: 10px; text-decoration: none;'>Adicionar dependentes de $vnome</a>";
                echo "<a href='addassociado.php' style='display: block; background-color: #cccccc; width: auto; margin: 10px; padding: 10px; text-decoration: none;'>Adicionar Novo Associado</a>";
                echo "<a href='dashboard.php' style='display: block; background-color: #cccccc; width: auto; margin: 10px; padding: 10px; text-decoration: none;'>Menu principal</a>";
            }
        }
